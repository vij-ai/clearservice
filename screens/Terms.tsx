    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <Text>
          ...
          bound by the then current version of these terms of service. 8. You
          acknowledge and agree that you are atleast 18 years old or older. You
          will not use Celsius to “stalk”, harass, intimidate, abuse, defame,
          threaten or defraud other Users. You will not Make use of obscene,
          offensive or pornographic materials, or materials that depict minors
          or are in any way harmful to minors. You will not use Celsius for any
          illegal purpose, or in violation of any law, whether local, state,
          national, international or otherwise, including but not limited to
          laws governing intellectual property and other proprietary rights,
          data protection and privacy, and import or export control 9. Governing
          Law These terms and conditions are governed by and construed in
          accordance with the laws of Kochi-Kerala-India and you irrevocably
