  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        ...
        <Text>
          You should be above 18 years old to use this app. Celsius Terms of
          Service 1. Terms By accessing our app, Celsius, you are agreeing to be
          ...
          prohibited from using or accessing Celsius. The materials contained in
          Celsius are protected by applicable copyright and trademark law. 2.
          Use License Permission is granted to temporarily download one copy of
          Celsius per device for personal, non-commercial transitory viewing
          only. This is the grant of a license, not a transfer of title, and
          under this license you may not: modify or copy the materials; use the
          ...
          engineer any software contained in Celsius; remove any copyright or
          ...
          of these restrictions and may be terminated by Celsius at any time.
          Upon terminating your viewing of these materials or upon the
          termination of this license, you must destroy any downloaded materials
          in your possession whether in electronic or printed format. 3.
          Disclaimer The materials within Celsius are provided on an 'as is'
          basis. Celsius makes no warranties, expressed or implied, and hereby
          disclaims and negates all other warranties including, without
          limitation, implied warranties or conditions of merchantability,
          fitness for a particular purpose, or non-infringement of intellectual
          property or other violation of rights. Further, Celsius does not
          ...
          Celsius. 4. Limitations In no event shall Celsius or its suppliers be
          ...
          of the use or inability to use Celsius, even if Celsius or a Celsius
          ...
          apply to you. 5. Accuracy of materials The materials appearing in
          Celsius could include technical, typographical, or photographic
          errors. Celsius does not warrant that any of the materials on Celsius
          are accurate, complete or current. Celsius may make changes to the
          materials contained in Celsius at any time without notice. However
          Celsius does not make any commitment to update the materials. 6. Links
          Celsius has not reviewed all of the sites linked to its app and is not
          responsible for the contents of any such linked site. The inclusion of
          any link does not imply endorsement by Celsius of the site. Use of any
          such linked website is at the user's own risk. 7. Modifications
          Celsius may revise these terms of service for its app at any time
          without notice. By using Celsius you are agreeing to be bound by the
          then current version of these terms of service. 8. Governing Law These
          terms and conditions are governed by and construed in accordance with
          the laws of Kochi and you irrevocably submit to the exclusive
